...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="stok">
                                <i class="fas fa-table"></i>stok</a>
                        </li>
                        <li>
                            <a href="jenisbarang">
                                <i class="far fa-check-square"></i>jenisbarang</a>
                        </li>
                        {{-- <li>
                            <a href="detail">
                                <i class="fas fa-chart-bar"></i>detail</a>
                        </li> --}}
                        <li>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="images/icon/logo.png" alt="Boneka" />
                </a>
            </div>
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="jenisbarang">jenisbarang</a>
                                </li>
                                <li>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="images/icon/avatar-01.jpg" alt="Rani" />
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">Rani Rahmawati</a>
                                                    </h5>
                                                    <span class="email">ranirahmawati0206@gmail.com</span>
                                                </div>
                                            </div>
