...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay" style="background-image: url(assets/frontend/img/mini.jpeg)">
      <div class="container">
        <div class="row site-hero-inner align-items-center">
          <div class="col-md-7 text-left mr-auto">
            <h1 class="heading" data-aos="fade-up">Macam Macan Boneka minions</h1>
          </div>
        </div>
    ...
    <section class="section bg-light post" id="next-section">
      <div class="container">
        <div class="row">
         ...
         <a href="{{url('/mini')}}"><img src="{{asset('assets/frontend/img/minions.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-up" data-aos-delay="100">
             <a href="{{url('/mini')}}"><img src="{{asset('assets/frontend/img/ms.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
            <div class="reviews-star float-left">
                <h4>Ukuran M</h4>
            </div>
            <h3><a href="property-single.html">$25.000</a></h3>
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-up" data-aos-delay="200">
             <a href="{{url('/mini')}}"><img src="{{asset('assets/frontend/img/ml.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
            <div class="reviews-star float-left">
                <h4>Ukuran L</h4>
            </div>
            <h3><a href="property-single.html">$25.000</a></h3>
           ...
           <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-up" data-aos-delay="200">
             <a href="{{url('/mini')}}"><img src="{{asset('assets/frontend/img/mb.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
           <div class="reviews-star float-left">
                <h4>Ukuran Xl</h4>
            </div>
            <h3><a href="property-single.html">$25.000</a></h3>
