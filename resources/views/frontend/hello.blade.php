...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay" style="background-image: url(assets/frontend/img/h.jpeg)">
      <div class="container">
    ...
    <section class="section bg-light post" id="next-section">
      <div class="container">
        <div class="row">
         ...
         <a href="{{url('/hello')}}"><img src="{{asset('assets/frontend/img/hs.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
