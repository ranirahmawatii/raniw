                    ...
                    <div class="card-body">
                        <form action="{{route('kategori.update', $kategori->id)}}" method="post">
                            ...
                            <div class="form-group">
                                <label for="">id</label>
                                <input class="form-control" type="text" name="id" id="" value="{{$kategori->id}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">nama</label>
                                <input class="form-control" type="text" name="nama" id="" value="{{$kategori->nama}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">slug</label>
                                <input class="form-control" type="text" name="slug" id="" value="{{$kategori->slug}}"disabled>
                            </div>
