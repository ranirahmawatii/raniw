...
<html lang="en">
  ...
  <body>
                    ...
                    <div class="col-md-6 extra-info">
                      <div class="row">
                        <div class="col-md-6 mb-5">
                          <h3>Contact Info</h3>
                          <p>Rani Rahmawati <br> Jln.Sukamenak Indah</p>
                          <p>ranirahmawati0206.com</p>
                          <p> +62 89671164584</p>
    ...
    <section class="site-hero overlay" style="background-image: url(assets/frontend/img/poto.jpeg)">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row">
         ...
         <a href="{{url('/elmo')}}"><img src="{{asset('assets/frontend/img/elmo.png')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-up">
            <a href="{{url('/poni')}}"><img src="{{asset('assets/frontend/img/poni.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
             <h4>Boneka Kuda Poni</h4><br>
            <h3><a href="property-single.html">$25.000</a></h3>
            <div class="reviews-star float-left">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-up" data-aos-delay="100">
            <a href="{{url('/stitch')}}"><img src="{{asset('assets/frontend/img/stitch.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
             <h4>Boneka Stitch</h4><br>
            <h3><a href="property-single.html">$25.000</a></h3>
            <div class="reviews-star float-left">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-up" data-aos-delay="200">
            <a href="{{url('/panda')}}"><img src="{{asset('assets/frontend/img/panda.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
             <h4>Boneka Panda</h4><br>
            <h3><a href="property-single.html">$25.000</a></h3>
            <div class="reviews-star float-left">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-up" data-aos-delay="300">
            <a href="{{url('/keropi')}}"><img src="{{asset('assets/frontend/img/keropi.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </<img>
             <h4>Boneka Keropi</h4><br>
            <h3><a href="property-single.html">$25.000</a></h3>
            <div class="reviews-star float-left">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
            <div class="media media-custom d-block mb-4">
              <a href="blog-single.html" class="mb-4 d-block"><img src="{{asset('assets/frontend/img/img_3.jpg')}}" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
                <h2 class="mt-0 mb-3"><a href="#">How to pick right realtor?</a></h2>
              </div>
